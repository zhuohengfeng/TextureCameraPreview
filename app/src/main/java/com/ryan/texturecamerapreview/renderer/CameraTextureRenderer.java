package com.ryan.texturecamerapreview.renderer;
...
import com.ryan.texturecamerapreview.api.ITextureRenderer;
import com.ryan.texturecamerapreview.utils.ResReadUtils;
import com.ryan.texturecamerapreview.utils.ShaderUtils;
...
public class CameraTextureRenderer implements ITextureRenderer {
    ...
    public void onSurfaceChanged(int width, int height) {
        Log.d("zhf-debug", "Render: onSurfaceChanged width="+width+", height="+height);
